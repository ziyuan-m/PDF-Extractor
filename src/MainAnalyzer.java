...
/**
 * This class contains the methods for analyzing pages
 */
public class MainAnalyzer {
    ...
    /**
     * Constructs a MainAnalyzer
     * @param inputFile is the file to be analyzed
     */
    ...
    /**
     * Get the page information for each page in the given PDF file
     * @param outputFile is the file to store the report
     * @throws IOException if the file to be analyzed does not exist
     */
    ...
    /**
     * Outputs the information of a page in PDF
     * @param fileContent the binary data containing the file content
     * @param output to output the information
     * @param objectResources all the objects in this PDF
     * @param pageDict the dictionary of the page to be printed
     * @param pageNum the number of the page to be printed
     */
