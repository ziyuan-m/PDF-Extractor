...
/**
 * This class contains methods for lexical analysis
 */
public class LexicalAnalyzer {

    /**
     * Transforms (tokenize) PDF source codes into tokens.
     * @param input is PDF codes to be transformed
     * @return a list of tokens transformed from the given PDF codes
     */
